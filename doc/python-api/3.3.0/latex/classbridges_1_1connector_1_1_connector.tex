...
It is not intended for external use \doxysubsection*{Public Member Functions}
...
\begin{DoxyCompactList}\small\item\em post the data (JSON) to the server \end{DoxyCompactList}\item 
...
\hline
{\em data} & JSON of the data structure representation \\
\hline
\end{DoxyParams}
...
\index{bridges.connector.Connector@{bridges.connector.Connector}!server\_url\_game@{server\_url\_game}}
\index{server\_url\_game@{server\_url\_game}!bridges.connector.Connector@{bridges.connector.Connector}}
\doxysubsubsection{\texorpdfstring{server\_url\_game}{server\_url\_game}}
