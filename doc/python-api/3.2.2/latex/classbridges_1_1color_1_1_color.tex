...
Attributes red (int)\+: red component of color ranging from 0-\/255 inclusive (default 0) green (int)\+: green component of color ranging from 0-\/255 inclusive (default 0) blue (int)\+: blue component of color ranging from 0-\/255 inclusive (default 0) alpha (float)\+: alpha component of color ranging from 0.\+0-\/1.\+0 inclusive (default 1.\+0) rgba (tuple(int, int, int, alpha))\+: R\+G\+BA components as respective tuple
...
Constructor for a \hyperlink{classbridges_1_1color_1_1_color}{Color} object Usage requires either 3 ints 0-\/255 for R\+GB and an optional float 0.\+0-\/1.\+0 for alpha or a str of a web color can also key the R\+G\+BA values with r, g, b, a or red, green, blue, alpha respectively and col\+\_\+name for the str. 
...
Requires either 3 ints 0-\/255 for R\+GB and an optional float 0.\+0-\/1.\+0 for alpha or a str of a web color can also key the R\+G\+BA values with r, g, b, a or red, green, blue, alpha respectively and col\+\_\+name for the str
