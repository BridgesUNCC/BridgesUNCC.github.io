...
\subsubsection{\texorpdfstring{set\_server()}{set\_server()}}
...
\subsubsection{\texorpdfstring{set\_server\_url()}{set\_server\_url()}}
...
\subsubsection{\texorpdfstring{pattern\_found}{pattern\_found}}
...
\subsubsection{\texorpdfstring{server\_type}{server\_type}}
...
\subsubsection{\texorpdfstring{server\_url\_clone}{server\_url\_clone}}
...
\subsubsection{\texorpdfstring{server\_url\_game}{server\_url\_game}}
...
\subsubsection{\texorpdfstring{server\_url\_live}{server\_url\_live}}
...
\subsubsection{\texorpdfstring{server\_url\_local}{server\_url\_local}}
