...
get the current data source object being used by B\+R\+I\+D\+G\+ES 
...
gets the debug flag value, used for debugging B\+R\+I\+D\+G\+ES 
...
\index{bridges\+::connect\+::\+Bridges@{bridges\+::connect\+::\+Bridges}!post\+Visualization\+Link@{post\+Visualization\+Link}}
\index{post\+Visualization\+Link@{post\+Visualization\+Link}!bridges\+::connect\+::\+Bridges@{bridges\+::connect\+::\+Bridges}}
...
Provide B\+R\+I\+D\+G\+ES a handle to the data structure to be visualized. 
