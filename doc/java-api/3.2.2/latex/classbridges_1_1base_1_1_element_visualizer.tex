...
Visual properties include color, shape, opacity, size and location. Objects of this class are stored as part of the \hyperlink{classbridges_1_1base_1_1_element}{Element} class. Generally, a user will manipulate the \hyperlink{classbridges_1_1base_1_1_element_visualizer}{Element\+Visualizer} returned from the \hyperlink{classbridges_1_1base_1_1_element}{Element}\textquotesingle{}s get\+Visualizer() method (rather than creating this object directly), and then set attributes using its methods. Supported attributed values are as follows\+:~\newline


{\bfseries \hyperlink{classbridges_1_1base_1_1_color}{Color}\+:} Supported colors by {\bfseries name} using \hyperlink{classbridges_1_1base_1_1_element_visualizer_ad7ff2a772741301c08943a58ffccca38}{set\+Color()}\+: See the \hyperlink{classbridges_1_1base_1_1_color}{Color} class for the complete list; colors are set by by R\+G\+BA Specification, 0-\/255 for each component, or using color names.

{\bfseries  Supported Shapes\+:} \char`\"{}circle\char`\"{}, \char`\"{}square\char`\"{}, \char`\"{}diamond\char`\"{}, \char`\"{}cross\char`\"{}, \char`\"{}triangle\char`\"{}, \char`\"{}star\char`\"{}, \char`\"{}wye\char`\"{}. set it with \hyperlink{classbridges_1_1base_1_1_element_visualizer_ac3bad991904c8ad23e5233b341381d93}{set\+Shape()} and \hyperlink{classbridges_1_1base_1_1_element_visualizer_a8ef0825745e49f32b57e4bf6c891b57e}{get\+Shape()}.

{\bfseries  Shape Size} \+: Range \mbox{[}0-\/50\mbox{]}. Set it with \hyperlink{classbridges_1_1base_1_1_element_visualizer_aba410184f7df495594fc1fa7948335a5}{set\+Size()} and \hyperlink{classbridges_1_1base_1_1_element_visualizer_a0b7673bf724e3df1f94df50ad95ca5b1}{get\+Size()}.

{\bfseries  Opacity\+: } Range \mbox{[}0.\+0 -\/ 1.\+0\mbox{]}. Use it with \hyperlink{classbridges_1_1base_1_1_element_visualizer_a932f62eb1bd0c92da265a7f903dd0790}{set\+Opacity()}, \hyperlink{classbridges_1_1base_1_1_element_visualizer_ab86ff39f17f8d1766670b18be88b5492}{get\+Opacity()}.

{\bfseries  Location\+: } Use it with \hyperlink{classbridges_1_1base_1_1_element_visualizer_a04f3416447f2042de7cd21ce5b6a0598}{set\+Location()}, \hyperlink{classbridges_1_1base_1_1_element_visualizer_aec8d0e757d323ff6122a2e05ab89f852}{get\+Location\+X()}, and \hyperlink{classbridges_1_1base_1_1_element_visualizer_ac170e945106f43cac3a3bdd950c60235}{get\+Location\+Y()}.
...
\begin{DoxyCompactList}\small\item\em Construct an \hyperlink{classbridges_1_1base_1_1_element_visualizer}{Element\+Visualizer} with given color, shape, opacity, and size. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Set the color of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Set the color of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization given R\+G\+BA components. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Get the opacity of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization. \end{DoxyCompactList}\item 
...
double \hyperlink{classbridges_1_1base_1_1_element_visualizer_aec8d0e757d323ff6122a2e05ab89f852}{get\+LocationX} ()
\begin{DoxyCompactList}\small\item\em Get the X coordinate position of the element. \end{DoxyCompactList}\item 
double \hyperlink{classbridges_1_1base_1_1_element_visualizer_ac170e945106f43cac3a3bdd950c60235}{get\+LocationY} ()
...
Construct an \hyperlink{classbridges_1_1base_1_1_element_visualizer}{Element\+Visualizer} with given color, shape, opacity, and size. 
...
\index{bridges\+::base\+::\+Element\+Visualizer@{bridges\+::base\+::\+Element\+Visualizer}!get\+LocationX@{get\+LocationX}}
\index{get\+LocationX@{get\+LocationX}!bridges\+::base\+::\+Element\+Visualizer@{bridges\+::base\+::\+Element\+Visualizer}}
...
\index{bridges\+::base\+::\+Element\+Visualizer@{bridges\+::base\+::\+Element\+Visualizer}!get\+LocationY@{get\+LocationY}}
\index{get\+LocationY@{get\+LocationY}!bridges\+::base\+::\+Element\+Visualizer@{bridges\+::base\+::\+Element\+Visualizer}}
...
Get the opacity of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization. 
...
Get the size of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization
...
Set the color of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization. 


\begin{DoxyParams}{Parameters}
{\em col\+\_\+name} & the string reprsenting the color of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization; see the \hyperlink{classbridges_1_1base_1_1_color}{Color} class for the list of supported colors \\
\hline
\end{DoxyParams}
...
Set the color of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization given R\+G\+BA components. 
...
\begin{DoxyParams}{Parameters}
{\em c} & \hyperlink{classbridges_1_1base_1_1_color}{Color} to set. \\
\hline
\end{DoxyParams}
...
Sets the opacity of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization (0.\+0-\/1.\+0)
...
\begin{DoxyParams}{Parameters}
{\em sz} & the pixel size of the \hyperlink{classbridges_1_1base_1_1_element}{Element} in the Bridges Visualization \\
\hline
\end{DoxyParams}
...
\item 
/home/erik/work/bridges/bridges-\/java/src/main/java/bridges/base/\hyperlink{_element_visualizer_8java}{Element\+Visualizer.\+java}\end{DoxyCompactItemize}
