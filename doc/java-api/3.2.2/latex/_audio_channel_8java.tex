...
\begin{DoxyCompactList}\small\item\em This class provides support for audio A\+PI in bridges; this class stores the properties and audio data of a single channel. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Packages}
\begin{DoxyCompactItemize}
\item 
