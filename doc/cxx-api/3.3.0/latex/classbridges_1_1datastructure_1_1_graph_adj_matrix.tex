\hypertarget{classbridges_1_1datastructure_1_1_graph_adj_matrix}{}\doxysection{bridges\+::datastructure\+::Graph\+Adj\+Matrix$<$ K, E1, E2 $>$ Class Template Reference}
...
The class is simply a wrapper around the C++ STL unordered\+\_\+map class and thus derives all its operations from it. Given the use of operator overloading, the adjacency matrix implementation is almost identical to a normal array representation, except that any ordered type can be used to index into the matrix.
...
\end{DoxyDate}
There is a tutorial about Graph Adjacency Matrix \+: \href{https://bridgesuncc.github.io/tutorials/Graph_AM.html}{\texttt{ https\+://bridgesuncc.\+github.\+io/tutorials/\+Graph\+\_\+\+AM.\+html}} \doxysubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
virtual const string \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix_a2f8c67da1078354156fc646097152c6d}{get\+DStype}} () const override
\item 
virtual \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix_ad4715c14dccce7f40fb91f8d31c9e55b}{$\sim$\+Graph\+Adj\+Matrix}} ()
\item 
\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix_a43d51f3dcb175767b28555494eb3aee1}{Graph\+Adj\+Matrix}} ()=default
\item 
\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix_a08f3ae1748d5eeb88fa2d99c8427e534}{Graph\+Adj\+Matrix}} (const \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}} \&)=delete
\item 
\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}} \& \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix_a6203e8d0b6feabdbd1b7ea0619dbe063}{operator=}} (const \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}} \&)=delete
\item 
...
\mbox{\Hypertarget{classbridges_1_1datastructure_1_1_graph_adj_matrix_ad4715c14dccce7f40fb91f8d31c9e55b}\label{classbridges_1_1datastructure_1_1_graph_adj_matrix_ad4715c14dccce7f40fb91f8d31c9e55b}} 
\index{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}!````~GraphAdjMatrix@{$\sim$GraphAdjMatrix}}
\index{````~GraphAdjMatrix@{$\sim$GraphAdjMatrix}!bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}}
\doxysubsubsection{\texorpdfstring{$\sim$GraphAdjMatrix()}{~GraphAdjMatrix()}}
{\footnotesize\ttfamily template$<$typename K , typename E1  = K, typename E2  = E1$>$ \\
virtual \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{bridges\+::datastructure\+::\+Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$\+::$\sim$\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}

\mbox{\Hypertarget{classbridges_1_1datastructure_1_1_graph_adj_matrix_a43d51f3dcb175767b28555494eb3aee1}\label{classbridges_1_1datastructure_1_1_graph_adj_matrix_a43d51f3dcb175767b28555494eb3aee1}} 
\index{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}!GraphAdjMatrix@{GraphAdjMatrix}}
\index{GraphAdjMatrix@{GraphAdjMatrix}!bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}}
\doxysubsubsection{\texorpdfstring{GraphAdjMatrix()}{GraphAdjMatrix()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename K , typename E1  = K, typename E2  = E1$>$ \\
\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{bridges\+::datastructure\+::\+Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$\+::\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [default]}}

\mbox{\Hypertarget{classbridges_1_1datastructure_1_1_graph_adj_matrix_a08f3ae1748d5eeb88fa2d99c8427e534}\label{classbridges_1_1datastructure_1_1_graph_adj_matrix_a08f3ae1748d5eeb88fa2d99c8427e534}} 
\index{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}!GraphAdjMatrix@{GraphAdjMatrix}}
\index{GraphAdjMatrix@{GraphAdjMatrix}!bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}}
\doxysubsubsection{\texorpdfstring{GraphAdjMatrix()}{GraphAdjMatrix()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename K , typename E1  = K, typename E2  = E1$>$ \\
\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{bridges\+::datastructure\+::\+Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$\+::\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}} (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$ \&}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [delete]}}
...
{\footnotesize\ttfamily template$<$typename K , typename E1  = K, typename E2  = E1$>$ \\
virtual const string \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{bridges\+::datastructure\+::\+Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$\+::get\+DStype (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{classbridges_1_1datastructure_1_1_graph_adj_matrix_a6203e8d0b6feabdbd1b7ea0619dbe063}\label{classbridges_1_1datastructure_1_1_graph_adj_matrix_a6203e8d0b6feabdbd1b7ea0619dbe063}} 
\index{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}!operator=@{operator=}}
\index{operator=@{operator=}!bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$@{bridges::datastructure::GraphAdjMatrix$<$ K, E1, E2 $>$}}
\doxysubsubsection{\texorpdfstring{operator=()}{operator=()}}
{\footnotesize\ttfamily template$<$typename K , typename E1  = K, typename E2  = E1$>$ \\
\mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}}\& \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{bridges\+::datastructure\+::\+Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$\+::operator= (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classbridges_1_1datastructure_1_1_graph_adj_matrix}{Graph\+Adj\+Matrix}}$<$ K, E1, E2 $>$ \&}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [delete]}}
...
/home/erik/work/bridges/bridges-\/cxx/src/\mbox{\hyperlink{_graph_adj_matrix_8h}{Graph\+Adj\+Matrix.\+h}}\end{DoxyCompactItemize}
