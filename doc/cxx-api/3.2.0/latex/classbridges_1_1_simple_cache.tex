...
\index{bridges\+::\+Simple\+Cache@{bridges\+::\+Simple\+Cache}!````~Simple\+Cache@{$\sim$\+Simple\+Cache}}
\index{````~Simple\+Cache@{$\sim$\+Simple\+Cache}!bridges\+::\+Simple\+Cache@{bridges\+::\+Simple\+Cache}}
\subsubsection{\texorpdfstring{$\sim$\+Simple\+Cache()}{~SimpleCache()}}
